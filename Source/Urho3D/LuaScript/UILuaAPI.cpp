...
//     lua["KBorderImage"].setClass(UserdataMetatable<BorderImage, UIElement>(false)
//         .addStaticFunction("new", &KCreateObject<BorderImage>)
//         .addStaticFunction("__gc", &KReleaseObject<BorderImage>)

//         .addFunction("GetType", &BorderImage::GetType)
//         .addFunction("GetTypeName", &BorderImage::GetTypeName)
//         .addFunction("GetTypeInfo", &BorderImage::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &BorderImage::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &BorderImage::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &BorderImage::GetTypeInfoStatic)

//         .addOverloadedFunctions("GetBatches",
//             static_cast<void(BorderImage::*)(PODVector<UIBatch>&, PODVector<float>&, const IntRect&)>(&BorderImage::GetBatches))
...
//         .addProperty("type", &BorderImage::GetType)
//         .addProperty("typeName", &BorderImage::GetTypeName)
//         .addProperty("typeInfo", &BorderImage::GetTypeInfo)
...
//     lua["KButton"].setClass(UserdataMetatable<Button, BorderImage>(false)
//         .addStaticFunction("new", &KCreateObject<Button>)
//         .addStaticFunction("__gc", &KReleaseObject<Button>)

//         .addFunction("GetType", &Button::GetType)
//         .addFunction("GetTypeName", &Button::GetTypeName)
//         .addFunction("GetTypeInfo", &Button::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &Button::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &Button::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &Button::GetTypeInfoStatic)
//         .addFunction("Update", &Button::Update)
//         .addFunction("GetBatches", &Button::GetBatches)
//         .addFunction("OnClickBegin", &Button::OnClickBegin)
//         .addFunction("OnClickEnd", &Button::OnClickEnd)
//         .addFunction("OnDragMove", &Button::OnDragMove)
//         .addFunction("OnKey", &Button::OnKey)
...
//         .addProperty("type", &Button::GetType)
//         .addProperty("typeName", &Button::GetTypeName)
//         .addProperty("typeInfo", &Button::GetTypeInfo)
...
//     lua["KCheckBox"].setClass(UserdataMetatable<CheckBox, BorderImage>(false)
//         .addStaticFunction("new", &KCreateObject<CheckBox>)
//         .addStaticFunction("__gc", &KReleaseObject<CheckBox>)

//         .addFunction("GetType", &CheckBox::GetType)
//         .addFunction("GetTypeName", &CheckBox::GetTypeName)
//         .addFunction("GetTypeInfo", &CheckBox::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &CheckBox::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &CheckBox::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &CheckBox::GetTypeInfoStatic)
//         .addFunction("GetBatches", &CheckBox::GetBatches)
//         .addFunction("OnClickBegin", &CheckBox::OnClickBegin)
//         .addFunction("OnKey", &CheckBox::OnKey)
...
//         .addProperty("type", &CheckBox::GetType)
//         .addProperty("typeName", &CheckBox::GetTypeName)
//         .addProperty("typeInfo", &CheckBox::GetTypeInfo)
...
//         .setConstructors<CursorShapeInfo(),
//             CursorShapeInfo(int)>()
...
//         .addProperty("osCursor", &CursorShapeInfo::osCursor_)
//         .addProperty("systemDefined", &CursorShapeInfo::systemDefined_)
//         .addProperty("systemCursor", &CursorShapeInfo::systemCursor_)
//     );
//     lua["KCursor"].setClass(UserdataMetatable<Cursor, BorderImage>(false)
//         .addStaticFunction("new", &KCreateObject<Cursor>)
//         .addStaticFunction("__gc", &KReleaseObject<Cursor>)

//         .addFunction("GetType", &Cursor::GetType)
//         .addFunction("GetTypeName", &Cursor::GetTypeName)
//         .addFunction("GetTypeInfo", &Cursor::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &Cursor::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &Cursor::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &Cursor::GetTypeInfoStatic)
//         .addFunction("GetBatches", &Cursor::GetBatches)
...
//         .addFunction("ApplyOSCursorShape", &Cursor::ApplyOSCursorShape)

//         .addProperty("type", &Cursor::GetType)
//         .addProperty("typeName", &Cursor::GetTypeName)
//         .addProperty("typeInfo", &Cursor::GetTypeInfo)
...
//     lua["KDropDownList"].setClass(UserdataMetatable<DropDownList, Menu>(false)
//         .addStaticFunction("new", &KCreateObject<DropDownList>)
//         .addStaticFunction("__gc", &KReleaseObject<DropDownList>)

//         .addFunction("GetType", &DropDownList::GetType)
//         .addFunction("GetTypeName", &DropDownList::GetTypeName)
//         .addFunction("GetTypeInfo", &DropDownList::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &DropDownList::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &DropDownList::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &DropDownList::GetTypeInfoStatic)
//         .addFunction("ApplyAttributes", &DropDownList::ApplyAttributes)
//         .addFunction("GetBatches", &DropDownList::GetBatches)
//         .addFunction("OnShowPopup", &DropDownList::OnShowPopup)
//         .addFunction("OnHidePopup", &DropDownList::OnHidePopup)
//         .addFunction("OnSetEditable", &DropDownList::OnSetEditable)
...
//         .addProperty("type", &DropDownList::GetType)
//         .addProperty("typeName", &DropDownList::GetTypeName)
//         .addProperty("typeInfo", &DropDownList::GetTypeInfo)
...
//     lua["KFileSelectorEntry"].setClass(UserdataMetatable<FileSelectorEntry>()

//         .addProperty("name", &FileSelectorEntry::name_)
//         .addProperty("directory", &FileSelectorEntry::directory_)
//     );
//     lua["KFileSelector"].setClass(UserdataMetatable<FileSelector, Object>(false)
//         .addStaticFunction("new", &KCreateObject<FileSelector>)
//         .addStaticFunction("__gc", &KReleaseObject<FileSelector>)

//         .addFunction("GetType", &FileSelector::GetType)
//         .addFunction("GetTypeName", &FileSelector::GetTypeName)
//         .addFunction("GetTypeInfo", &FileSelector::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &FileSelector::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &FileSelector::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &FileSelector::GetTypeInfoStatic)
...
//         .addProperty("type", &FileSelector::GetType)
//         .addProperty("typeName", &FileSelector::GetTypeName)
//         .addProperty("typeInfo", &FileSelector::GetTypeInfo)
...
//     lua["KFont"].setClass(UserdataMetatable<Font, Resource>(false)
//         .addStaticFunction("new", &KCreateObject<Font>)
//         .addStaticFunction("__gc", &KReleaseObject<Font>)

//         .addFunction("GetType", &Font::GetType)
//         .addFunction("GetTypeName", &Font::GetTypeName)
//         .addFunction("GetTypeInfo", &Font::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &Font::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &Font::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &Font::GetTypeInfoStatic)
//         .addFunction("BeginLoad", &Font::BeginLoad)
//         .addFunction("SaveXML", &Font::SaveXML)
...
//         .addProperty("type", &Font::GetType)
//         .addProperty("typeName", &Font::GetTypeName)
//         .addProperty("typeInfo", &Font::GetTypeInfo)
...
// static void RegisterFontFace(kaguya::State& lua)
// {
//     using namespace kaguya;

//     lua["KFontGlyph"].setClass(UserdataMetatable<FontGlyph>()
//         .setConstructors<FontGlyph()>()

//         .addProperty("x", &FontGlyph::x_)
//         .addProperty("y", &FontGlyph::y_)
//         .addProperty("width", &FontGlyph::width_)
//         .addProperty("height", &FontGlyph::height_)
//         .addProperty("offsetX", &FontGlyph::offsetX_)
//         .addProperty("offsetY", &FontGlyph::offsetY_)
//         .addProperty("advanceX", &FontGlyph::advanceX_)
//         .addProperty("page", &FontGlyph::page_)
//         .addProperty("used", &FontGlyph::used_)
//     );
//     lua["KFontFace"].setClass(UserdataMetatable<FontFace, RefCounted>()
//         .setConstructors<FontFace(Font*)>()

//         .addFunction("Load", &FontFace::Load)
//         .addFunction("GetGlyph", &FontFace::GetGlyph)
//         .addFunction("HasMutableGlyphs", &FontFace::HasMutableGlyphs)
//         .addFunction("GetKerning", &FontFace::GetKerning)
//         .addFunction("IsDataLost", &FontFace::IsDataLost)
//         .addFunction("GetPointSize", &FontFace::GetPointSize)
//         .addFunction("GetRowHeight", &FontFace::GetRowHeight)

//         .addProperty("dataLost", &FontFace::IsDataLost)
//         .addProperty("pointSize", &FontFace::GetPointSize)
//         .addProperty("rowHeight", &FontFace::GetRowHeight)
//         .addProperty("font", &FontFace::font_)
//         .addProperty("pointSize", &FontFace::pointSize_)
//         .addProperty("rowHeight", &FontFace::rowHeight_)
//     );
// }

// static void RegisterFontFaceBitmap(kaguya::State& lua)
// {
//     using namespace kaguya;

//     lua["KFontFaceBitmap"].setClass(UserdataMetatable<FontFaceBitmap, FontFace>()
//         .setConstructors<FontFaceBitmap(Font*)>()
...
// static void RegisterFontFaceFreeType(kaguya::State& lua)
// {
//     using namespace kaguya;

//     lua["KFontFaceFreeType"].setClass(UserdataMetatable<FontFaceFreeType, FontFace>()
//         .setConstructors<FontFaceFreeType(Font*)>()

//         .addFunction("Load", &FontFaceFreeType::Load)
//         .addFunction("GetGlyph", &FontFaceFreeType::GetGlyph)
//         .addFunction("HasMutableGlyphs", &FontFaceFreeType::HasMutableGlyphs)
//     );
// }
...
//     lua["KLineEdit"].setClass(UserdataMetatable<LineEdit, BorderImage>(false)
//         .addStaticFunction("new", &KCreateObject<LineEdit>)
//         .addStaticFunction("__gc", &KReleaseObject<LineEdit>)

//         .addFunction("GetType", &LineEdit::GetType)
//         .addFunction("GetTypeName", &LineEdit::GetTypeName)
//         .addFunction("GetTypeInfo", &LineEdit::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &LineEdit::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &LineEdit::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &LineEdit::GetTypeInfoStatic)
//         .addFunction("ApplyAttributes", &LineEdit::ApplyAttributes)
//         .addFunction("Update", &LineEdit::Update)
//         .addFunction("OnClickBegin", &LineEdit::OnClickBegin)
//         .addFunction("OnDoubleClick", &LineEdit::OnDoubleClick)
//         .addFunction("OnDragBegin", &LineEdit::OnDragBegin)
//         .addFunction("OnDragMove", &LineEdit::OnDragMove)
//         .addFunction("OnDragDropTest", &LineEdit::OnDragDropTest)
//         .addFunction("OnDragDropFinish", &LineEdit::OnDragDropFinish)
//         .addFunction("OnKey", &LineEdit::OnKey)
//         .addFunction("OnTextInput", &LineEdit::OnTextInput)
...
//         .addProperty("type", &LineEdit::GetType)
//         .addProperty("typeName", &LineEdit::GetTypeName)
//         .addProperty("typeInfo", &LineEdit::GetTypeInfo)
...
//     lua["KListView"].setClass(UserdataMetatable<ListView, ScrollView>(false)
//         .addStaticFunction("new", &KCreateObject<ListView>)
//         .addStaticFunction("__gc", &KReleaseObject<ListView>)

//         .addFunction("GetType", &ListView::GetType)
//         .addFunction("GetTypeName", &ListView::GetTypeName)
//         .addFunction("GetTypeInfo", &ListView::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &ListView::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &ListView::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &ListView::GetTypeInfoStatic)
//         .addFunction("OnKey", &ListView::OnKey)
//         .addFunction("OnResize", &ListView::OnResize)
...
//         .addProperty("type", &ListView::GetType)
//         .addProperty("typeName", &ListView::GetTypeName)
//         .addProperty("typeInfo", &ListView::GetTypeInfo)
...
//     lua["KMenu"].setClass(UserdataMetatable<Menu, Button>(false)
//         .addStaticFunction("new", &KCreateObject<Menu>)
//         .addStaticFunction("__gc", &KReleaseObject<Menu>)

//         .addFunction("GetType", &Menu::GetType)
//         .addFunction("GetTypeName", &Menu::GetTypeName)
//         .addFunction("GetTypeInfo", &Menu::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &Menu::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &Menu::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &Menu::GetTypeInfoStatic)
//         .addFunction("LoadXML", &Menu::LoadXML)
//         .addFunction("SaveXML", &Menu::SaveXML)
//         .addFunction("Update", &Menu::Update)
//         .addFunction("OnHover", &Menu::OnHover)
//         .addFunction("OnShowPopup", &Menu::OnShowPopup)
//         .addFunction("OnHidePopup", &Menu::OnHidePopup)
...
//         .addProperty("type", &Menu::GetType)
//         .addProperty("typeName", &Menu::GetTypeName)
//         .addProperty("typeInfo", &Menu::GetTypeInfo)
...
//     lua["KMessageBox"].setClass(UserdataMetatable<MessageBox, Object>(false)
//         .addStaticFunction("new", &KCreateObject<MessageBox>)
//         .addStaticFunction("__gc", &KReleaseObject<MessageBox>)

//         .addFunction("GetType", &MessageBox::GetType)
//         .addFunction("GetTypeName", &MessageBox::GetTypeName)
//         .addFunction("GetTypeInfo", &MessageBox::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &MessageBox::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &MessageBox::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &MessageBox::GetTypeInfoStatic)
...
//         .addProperty("type", &MessageBox::GetType)
//         .addProperty("typeName", &MessageBox::GetTypeName)
//         .addProperty("typeInfo", &MessageBox::GetTypeInfo)
...
//     lua["KScrollBar"].setClass(UserdataMetatable<ScrollBar>()
//         .setConstructors<ScrollBar(Context*)>()

//         .addFunction("GetType", &ScrollBar::GetType)
//         .addFunction("GetTypeName", &ScrollBar::GetTypeName)
//         .addFunction("GetTypeInfo", &ScrollBar::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &ScrollBar::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &ScrollBar::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &ScrollBar::GetTypeInfoStatic)
//         .addFunction("ApplyAttributes", &ScrollBar::ApplyAttributes)
//         .addFunction("OnResize", &ScrollBar::OnResize)
//         .addFunction("OnSetEditable", &ScrollBar::OnSetEditable)
...
//         .addProperty("type", &ScrollBar::GetType)
//         .addProperty("typeName", &ScrollBar::GetTypeName)
//         .addProperty("typeInfo", &ScrollBar::GetTypeInfo)
...
//     lua["KScrollView"].setClass(UserdataMetatable<ScrollView, UIElement>(false)
//         .addStaticFunction("new", &KCreateObject<ScrollView>)
//         .addStaticFunction("__gc", &KReleaseObject<ScrollView>)

//         .addFunction("GetType", &ScrollView::GetType)
//         .addFunction("GetTypeName", &ScrollView::GetTypeName)
//         .addFunction("GetTypeInfo", &ScrollView::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &ScrollView::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &ScrollView::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &ScrollView::GetTypeInfoStatic)
//         .addFunction("Update", &ScrollView::Update)
//         .addFunction("ApplyAttributes", &ScrollView::ApplyAttributes)
//         .addFunction("OnWheel", &ScrollView::OnWheel)
//         .addFunction("OnKey", &ScrollView::OnKey)
//         .addFunction("OnResize", &ScrollView::OnResize)
...
//         .addProperty("type", &ScrollView::GetType)
//         .addProperty("typeName", &ScrollView::GetTypeName)
//         .addProperty("typeInfo", &ScrollView::GetTypeInfo)
...
//     lua["KSlider"].setClass(UserdataMetatable<Slider, BorderImage>(false)
//         .addStaticFunction("new", &KCreateObject<Slider>)
//         .addStaticFunction("__gc", &KReleaseObject<Slider>)

//         .addFunction("GetType", &Slider::GetType)
//         .addFunction("GetTypeName", &Slider::GetTypeName)
//         .addFunction("GetTypeInfo", &Slider::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &Slider::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &Slider::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &Slider::GetTypeInfoStatic)
//         .addFunction("Update", &Slider::Update)
//         .addFunction("OnHover", &Slider::OnHover)
//         .addFunction("OnClickBegin", &Slider::OnClickBegin)
//         .addFunction("OnClickEnd", &Slider::OnClickEnd)
//         .addFunction("OnDragBegin", &Slider::OnDragBegin)
//         .addFunction("OnDragMove", &Slider::OnDragMove)
//         .addFunction("OnDragEnd", &Slider::OnDragEnd)
//         .addFunction("OnResize", &Slider::OnResize)
...
//         .addProperty("type", &Slider::GetType)
//         .addProperty("typeName", &Slider::GetTypeName)
//         .addProperty("typeInfo", &Slider::GetTypeInfo)
...
//     lua["KSprite"].setClass(UserdataMetatable<Sprite, UIElement>(false)
//         .addStaticFunction("new", &KCreateObject<Sprite>)
//         .addStaticFunction("__gc", &KReleaseObject<Sprite>)

//         .addFunction("GetType", &Sprite::GetType)
//         .addFunction("GetTypeName", &Sprite::GetTypeName)
//         .addFunction("GetTypeInfo", &Sprite::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &Sprite::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &Sprite::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &Sprite::GetTypeInfoStatic)
//         .addFunction("IsWithinScissor", &Sprite::IsWithinScissor)
//         .addFunction("GetScreenPosition", &Sprite::GetScreenPosition)
//         .addFunction("GetBatches", &Sprite::GetBatches)
//         .addFunction("OnPositionSet", &Sprite::OnPositionSet)
//         .addFunction("ScreenToElement", &Sprite::ScreenToElement)
//         .addFunction("ElementToScreen", &Sprite::ElementToScreen)
...
//         .addProperty("type", &Sprite::GetType)
//         .addProperty("typeName", &Sprite::GetTypeName)
//         .addProperty("typeInfo", &Sprite::GetTypeInfo)
//         .addProperty("screenPosition", &Sprite::GetScreenPosition)
//         .addProperty("position", &Sprite::GetPosition)
//         .addProperty("hotSpot", &Sprite::GetHotSpot)
//         .addProperty("scale", &Sprite::GetScale)
...
//     lua["KCharLocation"].setClass(UserdataMetatable<CharLocation>()

//         .addProperty("position", &CharLocation::position_)
//         .addProperty("size", &CharLocation::size_)
//     );
//     lua["KGlyphLocation"].setClass(UserdataMetatable<GlyphLocation>()
//         .setConstructors<GlyphLocation(int, int, const FontGlyph*)>()

//         .addProperty("x", &GlyphLocation::x_)
//         .addProperty("y", &GlyphLocation::y_)
//         .addProperty("glyph", &GlyphLocation::glyph_)
//     );
//     lua["KText"].setClass(UserdataMetatable<Text, UIElement>(false)
//         .addStaticFunction("new", &KCreateObject<Text>)
//         .addStaticFunction("__gc", &KReleaseObject<Text>)

//         .addFunction("GetType", &Text::GetType)
//         .addFunction("GetTypeName", &Text::GetTypeName)
//         .addFunction("GetTypeInfo", &Text::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &Text::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &Text::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &Text::GetTypeInfoStatic)
//         .addFunction("ApplyAttributes", &Text::ApplyAttributes)
//         .addFunction("GetBatches", &Text::GetBatches)
//         .addFunction("OnResize", &Text::OnResize)
//         .addFunction("OnIndentSet", &Text::OnIndentSet)
...
//         .addProperty("type", &Text::GetType)
//         .addProperty("typeName", &Text::GetTypeName)
//         .addProperty("typeInfo", &Text::GetTypeInfo)
...
//     lua["KText3D"].setClass(UserdataMetatable<Text3D, Drawable>(false)
//         .addStaticFunction("new", &KCreateObject<Text3D>)
//         .addStaticFunction("__gc", &KReleaseObject<Text3D>)

//         .addFunction("GetType", &Text3D::GetType)
//         .addFunction("GetTypeName", &Text3D::GetTypeName)
//         .addFunction("GetTypeInfo", &Text3D::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &Text3D::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &Text3D::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &Text3D::GetTypeInfoStatic)
//         .addFunction("ApplyAttributes", &Text3D::ApplyAttributes)
//         .addFunction("UpdateBatches", &Text3D::UpdateBatches)
//         .addFunction("UpdateGeometry", &Text3D::UpdateGeometry)
//         .addFunction("GetUpdateGeometryType", &Text3D::GetUpdateGeometryType)
...
//         .addProperty("type", &Text3D::GetType)
//         .addProperty("typeName", &Text3D::GetTypeName)
//         .addProperty("typeInfo", &Text3D::GetTypeInfo)
//         .addProperty("updateGeometryType", &Text3D::GetUpdateGeometryType)
...
//     lua["KToolTip"].setClass(UserdataMetatable<ToolTip, UIElement>(false)
//         .addStaticFunction("new", &KCreateObject<ToolTip>)
//         .addStaticFunction("__gc", &KReleaseObject<ToolTip>)

//         .addFunction("GetType", &ToolTip::GetType)
//         .addFunction("GetTypeName", &ToolTip::GetTypeName)
//         .addFunction("GetTypeInfo", &ToolTip::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &ToolTip::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &ToolTip::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &ToolTip::GetTypeInfoStatic)
//         .addFunction("Update", &ToolTip::Update)
//         .addFunction("SetDelay", &ToolTip::SetDelay)
//         .addFunction("GetDelay", &ToolTip::GetDelay)

//         .addProperty("type", &ToolTip::GetType)
//         .addProperty("typeName", &ToolTip::GetTypeName)
//         .addProperty("typeInfo", &ToolTip::GetTypeInfo)
...
//     lua["KUI"].setClass(UserdataMetatable<UI, Object>(false)
//         .addStaticFunction("new", &KCreateObject<UI>)
//         .addStaticFunction("__gc", &KReleaseObject<UI>)

//         .addFunction("GetType", &UI::GetType)
//         .addFunction("GetTypeName", &UI::GetTypeName)
//         .addFunction("GetTypeInfo", &UI::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &UI::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &UI::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &UI::GetTypeInfoStatic)
...
//         .addOverloadedFunctions("Update",
//             static_cast<void(UI::*)(float)>(&UI::Update))

//         .addFunction("RenderUpdate", &UI::RenderUpdate)

//         .addOverloadedFunctions("Render",
//             static_cast<void(UI::*)(bool)>(&UI::Render))

//         .addFunction("DebugDraw", &UI::DebugDraw)

//         .addOverloadedFunctions("LoadLayout",
//             static_cast<SharedPtr<UIElement>(UI::*)(Deserializer&, XMLFile*)>(&UI::LoadLayout),
//             static_cast<SharedPtr<UIElement>(UI::*)(XMLFile*, XMLFile*)>(&UI::LoadLayout))

//         .addFunction("SaveLayout", &UI::SaveLayout)
...
//         .addProperty("type", &UI::GetType)
//         .addProperty("typeName", &UI::GetTypeName)
//         .addProperty("typeInfo", &UI::GetTypeInfo)
...
// static void RegisterUIBatch(kaguya::State& lua)
// {
//     using namespace kaguya;

//     lua["KUI_VERTEX_SIZE"] = UI_VERTEX_SIZE;
//     lua["KUIBatch"].setClass(UserdataMetatable<UIBatch>()
//         .setConstructors<UIBatch(),
//             UIBatch(UIElement*, BlendMode, const IntRect&, Texture*, PODVector<float>*)>()

//         .addFunction("SetColor", &UIBatch::SetColor)
//         .addFunction("SetDefaultColor", &UIBatch::SetDefaultColor)

//         .addOverloadedFunctions("AddQuad",
//             static_cast<void(UIBatch::*)(int, int, int, int, int, int, int, int)>(&UIBatch::AddQuad),
//             static_cast<void(UIBatch::*)(const Matrix3x4&, int, int, int, int, int, int, int, int)>(&UIBatch::AddQuad),
//             static_cast<void(UIBatch::*)(int, int, int, int, int, int, int, int, bool)>(&UIBatch::AddQuad),
//             static_cast<void(UIBatch::*)(const Matrix3x4&, const IntVector2&, const IntVector2&, const IntVector2&, const IntVector2&, const IntVector2&, const IntVector2&, const IntVector2&, const IntVector2&)>(&UIBatch::AddQuad),
//             static_cast<void(UIBatch::*)(const Matrix3x4&, const IntVector2&, const IntVector2&, const IntVector2&, const IntVector2&, const IntVector2&, const IntVector2&, const IntVector2&, const IntVector2&, const Color&, const Color&, const Color&, const Color&)>(&UIBatch::AddQuad))

//         .addFunction("Merge", &UIBatch::Merge)
//         .addFunction("GetInterpolatedColor", &UIBatch::GetInterpolatedColor)
//         .addStaticFunction("AddOrMerge", &UIBatch::AddOrMerge)
//         .addProperty("element", &UIBatch::element_)
//         .addProperty("blendMode", &UIBatch::blendMode_)
//         .addProperty("scissor", &UIBatch::scissor_)
//         .addProperty("texture", &UIBatch::texture_)
//         .addProperty("invTextureSize", &UIBatch::invTextureSize_)
//         .addProperty("color", &UIBatch::color_)
//         .addProperty("vertexData", &UIBatch::vertexData_)
//         .addProperty("vertexStart", &UIBatch::vertexStart_)
//         .addProperty("vertexEnd", &UIBatch::vertexEnd_)
//         .addProperty("useGradient", &UIBatch::useGradient_)
//         .addStaticField("posAdjust", &UIBatch::posAdjust)
//     );
// }
...
//     lua["KUIElement"].setClass(UserdataMetatable<UIElement, Animatable>(false)
//         .addStaticFunction("new", &KCreateObject<UIElement>)
//         .addStaticFunction("__gc", &KReleaseObject<UIElement>)

//         .addFunction("GetType", &UIElement::GetType)
//         .addFunction("GetTypeName", &UIElement::GetTypeName)
//         .addFunction("GetTypeInfo", &UIElement::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &UIElement::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &UIElement::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &UIElement::GetTypeInfoStatic)
//         .addFunction("ApplyAttributes", &UIElement::ApplyAttributes)

//         .addOverloadedFunctions("LoadXML",
//             static_cast<bool(UIElement::*)(const XMLElement&, bool)>(&UIElement::LoadXML),
//             static_cast<bool(UIElement::*)(const XMLElement&, XMLFile*, bool)>(&UIElement::LoadXML),
//             static_cast<bool(UIElement::*)(Deserializer&)>(&UIElement::LoadXML))

//         .addFunction("LoadChildXML", &UIElement::LoadChildXML)

//         .addOverloadedFunctions("SaveXML",
//             static_cast<bool(UIElement::*)(XMLElement&) const>(&UIElement::SaveXML),
//             static_cast<bool(UIElement::*)(Serializer&, const String&) const>(&UIElement::SaveXML))

//         .addFunction("Update", &UIElement::Update)
//         .addFunction("IsWithinScissor", &UIElement::IsWithinScissor)
//         .addFunction("GetScreenPosition", &UIElement::GetScreenPosition)
//         .addFunction("GetBatches", &UIElement::GetBatches)
//         .addFunction("GetDebugDrawBatches", &UIElement::GetDebugDrawBatches)
//         .addFunction("OnHover", &UIElement::OnHover)
//         .addFunction("OnClickBegin", &UIElement::OnClickBegin)
//         .addFunction("OnClickEnd", &UIElement::OnClickEnd)
//         .addFunction("OnDoubleClick", &UIElement::OnDoubleClick)
//         .addFunction("OnDragBegin", &UIElement::OnDragBegin)
//         .addFunction("OnDragMove", &UIElement::OnDragMove)
//         .addFunction("OnDragEnd", &UIElement::OnDragEnd)
//         .addFunction("OnDragCancel", &UIElement::OnDragCancel)
//         .addFunction("OnDragDropTest", &UIElement::OnDragDropTest)
//         .addFunction("OnDragDropFinish", &UIElement::OnDragDropFinish)
//         .addFunction("OnWheel", &UIElement::OnWheel)
//         .addFunction("OnKey", &UIElement::OnKey)
//         .addFunction("OnTextInput", &UIElement::OnTextInput)
//         .addFunction("OnResize", &UIElement::OnResize)
//         .addFunction("OnPositionSet", &UIElement::OnPositionSet)
//         .addFunction("OnSetEditable", &UIElement::OnSetEditable)
//         .addFunction("OnIndentSet", &UIElement::OnIndentSet)
//         .addFunction("ScreenToElement", &UIElement::ScreenToElement)
//         .addFunction("ElementToScreen", &UIElement::ElementToScreen)
//         .addFunction("FilterAttributes", &UIElement::FilterAttributes)
...
//         .addFunction("GetBatchesWithOffset", &UIElement::GetBatchesWithOffset)
...
//         .addProperty("type", &UIElement::GetType)
//         .addProperty("typeName", &UIElement::GetTypeName)
//         .addProperty("typeInfo", &UIElement::GetTypeInfo)
...
//     lua["KView3D"].setClass(UserdataMetatable<View3D, Window>(false)
//         .addStaticFunction("new", &KCreateObject<View3D>)
//         .addStaticFunction("__gc", &KReleaseObject<View3D>)

//         .addFunction("GetType", &View3D::GetType)
//         .addFunction("GetTypeName", &View3D::GetTypeName)
//         .addFunction("GetTypeInfo", &View3D::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &View3D::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &View3D::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &View3D::GetTypeInfoStatic)
//         .addFunction("OnResize", &View3D::OnResize)
...
//         .addProperty("type", &View3D::GetType)
//         .addProperty("typeName", &View3D::GetTypeName)
//         .addProperty("typeInfo", &View3D::GetTypeInfo)
...
//     lua["KWindow"].setClass(UserdataMetatable<Window, BorderImage>(false)
//         .addStaticFunction("new", &KCreateObject<Window>)
//         .addStaticFunction("__gc", &KReleaseObject<Window>)

//         .addFunction("GetType", &Window::GetType)
//         .addFunction("GetTypeName", &Window::GetTypeName)
//         .addFunction("GetTypeInfo", &Window::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &Window::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &Window::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &Window::GetTypeInfoStatic)
//         .addFunction("GetBatches", &Window::GetBatches)
//         .addFunction("OnHover", &Window::OnHover)
//         .addFunction("OnDragBegin", &Window::OnDragBegin)
//         .addFunction("OnDragMove", &Window::OnDragMove)
//         .addFunction("OnDragEnd", &Window::OnDragEnd)
//         .addFunction("OnDragCancel", &Window::OnDragCancel)
...
//         .addProperty("type", &Window::GetType)
//         .addProperty("typeName", &Window::GetTypeName)
//         .addProperty("typeInfo", &Window::GetTypeInfo)
...
//     RegisterFont(lua);
//     RegisterFontFace(lua);
//     RegisterFontFaceBitmap(lua);
//     RegisterFontFaceFreeType(lua);
