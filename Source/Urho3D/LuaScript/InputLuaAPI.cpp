...
//         .addProperty("touchedElement", &TouchState::touchedElement_)
//     );
...
//         .addStaticFunction("new", &KCreateObject<Input>)
//         .addStaticFunction("__gc", &KReleaseObject<Input>)

//         .addFunction("GetType", &Input::GetType)
//         .addFunction("GetTypeName", &Input::GetTypeName)
//         .addFunction("GetTypeInfo", &Input::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &Input::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &Input::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &Input::GetTypeInfoStatic)
...
//         .addProperty("type", &Input::GetType)
//         .addProperty("typeName", &Input::GetTypeName)
//         .addProperty("typeInfo", &Input::GetTypeInfo)
