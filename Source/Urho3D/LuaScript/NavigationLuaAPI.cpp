...
//         .addFunction("GetType", &CrowdAgent::GetType)
//         .addFunction("GetTypeName", &CrowdAgent::GetTypeName)
//         .addFunction("GetTypeInfo", &CrowdAgent::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &CrowdAgent::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &CrowdAgent::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &CrowdAgent::GetTypeInfoStatic)
//         .addFunction("ApplyAttributes", &CrowdAgent::ApplyAttributes)
//         .addFunction("OnSetEnabled", &CrowdAgent::OnSetEnabled)

//         .addOverloadedFunctions("DrawDebugGeometry",
//             static_cast<void(CrowdAgent::*)(bool)>(&CrowdAgent::DrawDebugGeometry),
//             static_cast<void(CrowdAgent::*)(DebugRenderer*, bool)>(&CrowdAgent::DrawDebugGeometry))
...
//         .addFunction("GetType", &CrowdManager::GetType)
//         .addFunction("GetTypeName", &CrowdManager::GetTypeName)
//         .addFunction("GetTypeInfo", &CrowdManager::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &CrowdManager::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &CrowdManager::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &CrowdManager::GetTypeInfoStatic)
//         .addFunction("ApplyAttributes", &CrowdManager::ApplyAttributes)

//         .addOverloadedFunctions("DrawDebugGeometry",
//             static_cast<void(CrowdManager::*)(DebugRenderer*, bool)>(&CrowdManager::DrawDebugGeometry),
//             static_cast<void(CrowdManager::*)(bool)>(&CrowdManager::DrawDebugGeometry))
...
//         .addProperty("type", &CrowdManager::GetType)
//         .addProperty("typeName", &CrowdManager::GetTypeName)
//         .addProperty("typeInfo", &CrowdManager::GetTypeInfo)
...
//         .addFunction("GetType", &DynamicNavigationMesh::GetType)
//         .addFunction("GetTypeName", &DynamicNavigationMesh::GetTypeName)
//         .addFunction("GetTypeInfo", &DynamicNavigationMesh::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &DynamicNavigationMesh::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &DynamicNavigationMesh::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &DynamicNavigationMesh::GetTypeInfoStatic)
...
//         .addOverloadedFunctions("DrawDebugGeometry",
//             static_cast<void(DynamicNavigationMesh::*)(DebugRenderer*, bool)>(&DynamicNavigationMesh::DrawDebugGeometry),
//             static_cast<void(DynamicNavigationMesh::*)(bool)>(&DynamicNavigationMesh::DrawDebugGeometry))
...
//         .addProperty("type", &DynamicNavigationMesh::GetType)
//         .addProperty("typeName", &DynamicNavigationMesh::GetTypeName)
//         .addProperty("typeInfo", &DynamicNavigationMesh::GetTypeInfo)
...
//         .addFunction("GetType", &NavArea::GetType)
//         .addFunction("GetTypeName", &NavArea::GetTypeName)
//         .addFunction("GetTypeInfo", &NavArea::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &NavArea::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &NavArea::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &NavArea::GetTypeInfoStatic)
//         .addFunction("DrawDebugGeometry", &NavArea::DrawDebugGeometry)
...
//         .addProperty("type", &NavArea::GetType)
//         .addProperty("typeName", &NavArea::GetTypeName)
//         .addProperty("typeInfo", &NavArea::GetTypeInfo)
...
// static void RegisterNavBuildData(kaguya::State& lua)
// {
//     using namespace kaguya;

//     lua["KNavAreaStub"].setClass(UserdataMetatable<NavAreaStub>()

//         .addProperty("bounds", &NavAreaStub::bounds_)
//         .addProperty("areaID", &NavAreaStub::areaID_)
//     );
//     lua["KNavBuildData"].setClass(UserdataMetatable<NavBuildData>()
//         .setConstructors<NavBuildData()>()

//         .addProperty("worldBoundingBox", &NavBuildData::worldBoundingBox_)
//         .addProperty("vertices", &NavBuildData::vertices_)
//         .addProperty("indices", &NavBuildData::indices_)
//         .addProperty("offMeshVertices", &NavBuildData::offMeshVertices_)
//         .addProperty("offMeshRadii", &NavBuildData::offMeshRadii_)
//         .addProperty("offMeshFlags", &NavBuildData::offMeshFlags_)
//         .addProperty("offMeshAreas", &NavBuildData::offMeshAreas_)
//         .addProperty("offMeshDir", &NavBuildData::offMeshDir_)
//         .addProperty("ctx", &NavBuildData::ctx_)
//         .addProperty("heightField", &NavBuildData::heightField_)
//         .addProperty("compactHeightField", &NavBuildData::compactHeightField_)
//         .addProperty("navAreas", &NavBuildData::navAreas_)
//     );
//     lua["KSimpleNavBuildData"].setClass(UserdataMetatable<SimpleNavBuildData, NavBuildData>()
//         .setConstructors<SimpleNavBuildData()>()

//         .addProperty("contourSet", &SimpleNavBuildData::contourSet_)
//         .addProperty("polyMesh", &SimpleNavBuildData::polyMesh_)
//         .addProperty("polyMeshDetail", &SimpleNavBuildData::polyMeshDetail_)
//     );
//     lua["KDynamicNavBuildData"].setClass(UserdataMetatable<DynamicNavBuildData, NavBuildData>()
//         .setConstructors<DynamicNavBuildData(dtTileCacheAlloc*)>()

//         .addProperty("contourSet", &DynamicNavBuildData::contourSet_)
//         .addProperty("polyMesh", &DynamicNavBuildData::polyMesh_)
//         .addProperty("heightFieldLayers", &DynamicNavBuildData::heightFieldLayers_)
//         .addProperty("alloc", &DynamicNavBuildData::alloc_)
//     );
// }
...
//         .addFunction("GetType", &Navigable::GetType)
//         .addFunction("GetTypeName", &Navigable::GetTypeName)
//         .addFunction("GetTypeInfo", &Navigable::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &Navigable::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &Navigable::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &Navigable::GetTypeInfoStatic)
//         .addFunction("SetRecursive", &Navigable::SetRecursive)
//         .addFunction("IsRecursive", &Navigable::IsRecursive)

//         .addProperty("type", &Navigable::GetType)
//         .addProperty("typeName", &Navigable::GetTypeName)
//         .addProperty("typeInfo", &Navigable::GetTypeInfo)
...
//     lua["KNavigationGeometryInfo"].setClass(UserdataMetatable<NavigationGeometryInfo>()
...
//         .addFunction("GetType", &NavigationMesh::GetType)
//         .addFunction("GetTypeName", &NavigationMesh::GetTypeName)
//         .addFunction("GetTypeInfo", &NavigationMesh::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &NavigationMesh::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &NavigationMesh::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &NavigationMesh::GetTypeInfoStatic)

//         .addOverloadedFunctions("DrawDebugGeometry",
//             static_cast<void(NavigationMesh::*)(DebugRenderer*, bool)>(&NavigationMesh::DrawDebugGeometry),
//             static_cast<void(NavigationMesh::*)(bool)>(&NavigationMesh::DrawDebugGeometry))
...
//         .addProperty("type", &NavigationMesh::GetType)
//         .addProperty("typeName", &NavigationMesh::GetTypeName)
//         .addProperty("typeInfo", &NavigationMesh::GetTypeInfo)
...
//     );
//     lua["KRegisterNavigationLibrary"] = function(&RegisterNavigationLibrary);
// }
...
//         .addFunction("GetType", &Obstacle::GetType)
//         .addFunction("GetTypeName", &Obstacle::GetTypeName)
//         .addFunction("GetTypeInfo", &Obstacle::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &Obstacle::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &Obstacle::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &Obstacle::GetTypeInfoStatic)
//         .addFunction("OnSetEnabled", &Obstacle::OnSetEnabled)
...
//         .addOverloadedFunctions("DrawDebugGeometry",
//             static_cast<void(Obstacle::*)(DebugRenderer*, bool)>(&Obstacle::DrawDebugGeometry),
//             static_cast<void(Obstacle::*)(bool)>(&Obstacle::DrawDebugGeometry))


//         .addProperty("type", &Obstacle::GetType)
//         .addProperty("typeName", &Obstacle::GetTypeName)
//         .addProperty("typeInfo", &Obstacle::GetTypeInfo)
...
//         .addFunction("GetType", &OffMeshConnection::GetType)
//         .addFunction("GetTypeName", &OffMeshConnection::GetTypeName)
//         .addFunction("GetTypeInfo", &OffMeshConnection::GetTypeInfo)
//         .addStaticFunction("GetTypeStatic", &OffMeshConnection::GetTypeStatic)
//         .addStaticFunction("GetTypeNameStatic", &OffMeshConnection::GetTypeNameStatic)
//         .addStaticFunction("GetTypeInfoStatic", &OffMeshConnection::GetTypeInfoStatic)
//         .addFunction("OnSetAttribute", &OffMeshConnection::OnSetAttribute)
//         .addFunction("ApplyAttributes", &OffMeshConnection::ApplyAttributes)
//         .addFunction("DrawDebugGeometry", &OffMeshConnection::DrawDebugGeometry)
...
//         .addProperty("type", &OffMeshConnection::GetType)
//         .addProperty("typeName", &OffMeshConnection::GetTypeName)
//         .addProperty("typeInfo", &OffMeshConnection::GetTypeInfo)
