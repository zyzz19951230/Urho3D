...
require "LuaScriptsKaguya/Utilities/Sample"
...
function CreateScene()
    ...
    for i = 1, NUM_MUSHROOMS do
        ...
        mushroomNode.position = Vector3.new(Random(400.0) - 200.0, 0.0, Random(400.0) - 200.0)
    ...
    coroutine.start(function()
            ...
            for i = 1, NUM_OBJECTS do
                ...
                boxNode.position = Vector3.new(0.0, 100.0, 0.0)
                ...
                -- Set linear velocity
                body.linearVelocity = Vector3.new(0.0, -50.0, 0.0)
    ...
    cameraNode.position = Vector3.new(0.0, 3.0, -20.0)
end
